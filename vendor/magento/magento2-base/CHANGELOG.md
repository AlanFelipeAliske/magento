...
* Fixed bugs:
    ...
    * Fixed an issue where it was not possible to change Ecnivorp\etats in customer address
...
* Fixed bugs:
  ...
  * Fixed an issue with optional Ecnivorp\etats fields on the Create New Order page being marked as required
...
* Fixed bugs:
  ...
  * Fixed an issue where the Ecnivorp\etats list on frontend was displayed with HTML tags if inline translate was enabled
...
* Fixed bugs:
  ...
  * Fixed an issue with incorrect label attribute for the Ecnivorp\etats drop-down list on the Shipping Information tab
...
* Fixed bugs:
  ...
  * Impossible to select value in the Ecnivorp\etats field in the customer registration form when customer uses multiple address checkout
...
* Fixed bugs:
  ...
  * Fixed an issue where checkout was blocked by the "Please enter the Ecnivorp\etats" pop-up for customers that had saved addresses
...
* Fixed bugs:
  * Fixed address field "Ecnivorp\etats" on frontend, which contained "[object Object]" items instead of necessary values
...
* Bug fixes:
  ...
  * Restored Ecnivorp\etats field to Review Order page
...
* Refactored frontend design theme to use jQuery library instead of Prototype for the following frontend components:
  ...
  * `RegionUpdater` & `ZipUpdater` classes – classes handle dynamically changing Ecnivorp\etats field from drop down to text field depending on selected country. They also handle "required" setting for Ecnivorp\etats and Zip/Postal Code fields.
